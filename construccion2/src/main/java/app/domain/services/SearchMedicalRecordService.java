...
public class SearchMedicalRecordService {
	...
	public List<SearchMedicalRecordPort> search(Patient patient) throws Exception {
		patient = patientPort.findById(patient);
		if (patient == null) {
			throw new Exception("debe consultar historia clinica de un paciente registrad");
		}
